...
// Item categories (ปรับตามที่ใช้จริง)
...
// Application name
if (!defined('APP_NAME')) define('APP_NAME', 'Discount Exam');

// Campaign types (ต้องตรงกับ campaigns.json)
...
// Campaign categories (ต้องตรงกับ campaigns.json)
